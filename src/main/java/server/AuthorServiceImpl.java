...
public class AuthorServiceImpl extends AuthorServiceGrpc.AuthorServiceImplBase {
    ...
    @Override
    public void getAllAuthors(ServiceParams.Empty request, StreamObserver<AuthorOuterClass.Author> responseObserver) {
    ...
    @Override
    public void deleteAuthor(ServiceParams.AuthorRequestId request, StreamObserver<ServiceParams.Empty> responseObserver) {
