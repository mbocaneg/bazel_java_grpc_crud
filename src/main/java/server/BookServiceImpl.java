...
public class BookServiceImpl extends BookServiceGrpc.BookServiceImplBase {
    ...
    @Override
    public void getAllBooks(ServiceParams.Empty request, StreamObserver<BookOuterClass.Book> responseObserver) {
    ...
    @Override
    public void deleteBook(ServiceParams.BookRequestId request, StreamObserver<ServiceParams.Empty> responseObserver) {
